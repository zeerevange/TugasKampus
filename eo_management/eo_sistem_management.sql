...
--
-- Host: localhost
-- Generation Time: Jul 10, 2024 at 07:24 AM
...
--
-- Dumping data for table `crew_acara`
--

INSERT INTO `crew_acara` (`id_crew_acara`, `id_rincian_acara`, `id_karyawan`, `tipe_crew_acara`) VALUES
(1, 1, 'ID00004', 'Fasilitator'),
(2, 1, 'ID00003', 'Master Game'),
(3, 1, 'ID00002', 'MC'),
(4, 2, 'ID00005', 'Master Game'),
(5, 2, 'ID00004', 'MC');
...
('IN00004', 'Laptop', 4, 'Untuk oprasional lapangan');
...
(1, 'Admin Webs', '3000000', 'Input data karyawan'),
...
('ID00006', 'Vera', 'Perempuan', '089762728292', 'vera@outoria.com', 3);
...
INSERT INTO `pembayaran` (`id_pembayaran`, `id_pesanan_layanan`, `tanggal_pembayaran`, `jumlah_pembayaran`, `sisa_pembayaran`, `tipe_pembayaran`, `tujuan_rekening_bank_pembayan`) VALUES
('TRX00001', 'INV00002', '2024-07-08', 20000000, 7972000, 'Transfer Bank', 'BCA'),
('TRX00003', 'INV00002', '2024-07-09', 7972000, 0, 'Transfer Bank', 'BCA'),
('TRX00004', 'INV00001', '2024-07-09', 15000000, 5257500, 'Transfer Bank', 'BRI'),
('TRX00005', 'INV00001', '2024-07-10', 3000000, 2257500, 'Transfer Bank', 'BRI'),
('TRX00006', 'INV00001', '2024-07-10', 2257500, 0, 'Transfer Bank', 'BRI');
...
('INV00001AN', 'AN00002', 'INV00002', 50, 0),
('INV00002AN', 'AN00003', 'INV00001', 2, 0),
('INV00003AN', 'AN00003', 'INV00004', 3, 0),
('INV00004AN', 'AN00003', 'INV00006', 2, 0),
('INV00005AN', 'AN00002', 'INV00005', 120, 0),
('INV00006AN', 'AN00003', 'INV00005', 5, 0);
...
--
-- Dumping data for table `rincian_acara`
--

INSERT INTO `rincian_acara` (`id_rincian_acara`, `id_pesanan_layanan`, `tanggal_rincian_acara`, `venue_rincian_acara`) VALUES
(1, 'INV00004', '2024-07-31', 'Villa Khayangan - Sentul'),
(2, 'INV00001', '2024-07-31', 'Sirkuit Sentul');
...
--
-- Dumping data for table `rincian_game_acara`
--

INSERT INTO `rincian_game_acara` (`id_rincian_game_acara`, `id_rincian_acara`, `id_game`) VALUES
(1, 1, 2),
(2, 1, 3),
(3, 2, 1);
...
(1, 3, 'ID00002', '0192023a7bbd73250516f069df18b500');
...
--
ALTER TABLE `crew_acara`
  MODIFY `id_crew_acara` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `rincian_acara`
  MODIFY `id_rincian_acara` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `rincian_game_acara`
--
ALTER TABLE `rincian_game_acara`
  MODIFY `id_rincian_game_acara` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `sub_kategori_addon`
  MODIFY `id_sub_kategori_addon` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
