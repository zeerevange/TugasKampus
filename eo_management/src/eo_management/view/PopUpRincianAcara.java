 ...
 * @author it
 */
public class PopUpRincianAcara extends javax.swing.JDialog {
     ...
     */
    public PopUpRincianAcara(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dataTable();
    }
    ...
    public static void setScreenType (String screen_type) {
        PopUpRincianAcara.screen_type = screen_type;
    }
    ...
    protected void dataTable() {
        Object[] header = {"ID Acara", "Nama PIC", "Kontak PIC", "Perusahaan", "Tanggal", "Venue"};
        tabmode = new DefaultTableModel (null, header);
        String cariitem = txtCari.getText();
        
        try {
            String sql = "SELECT \n" +
                        "rincian_acara.id_rincian_acara,\n" +
                        "pelanggan.nama_pelanggan,\n" +
                        "pelanggan.no_telp_pelanggan,\n" +
                        "perusahaan_pelanggan.nama_perusahaan_pelanggan,\n" +
                        "rincian_acara.tanggal_rincian_acara,\n" +
                        "rincian_acara.venue_rincian_acara\n" +
                        "FROM rincian_acara\n" +
                        "LEFT JOIN pesanan_layanan ON pesanan_layanan.id_pesanan_layanan = rincian_acara.id_pesanan_layanan\n" +
                    ...
                    + cariitem+ "%' or rincian_acara.venue_rincian_acara LIKE '%" 
                    + cariitem+ "%' or perusahaan_pelanggan.nama_perusahaan_pelanggan LIKE '%"
                    + cariitem+ "%' ORDER BY rincian_acara.id_rincian_acara asc";
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Data Rincian Acara", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    private void tabelPelangganMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelPelangganMouseClicked
        ...
        if(pilihan == 1){
            this.dispose();
            throwDataPesanan.setId_RincianAcara(id);
            ...
            } else if (this.screen_type == "Rincian Game Acara") {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpRincianAcara.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PopUpRincianAcara dialog = new PopUpRincianAcara(new javax.swing.JFrame(), true);
