 ...
 * @author it
 */
public class PopUpKaryawan extends javax.swing.JDialog {
     ...
     */
    public PopUpKaryawan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dataTable();
    }
    ...
    protected void dataTable() {
        Object[] header = {"ID", "Nama Karyawan", "Jabatan", "No Telpon", "Email", "Jenis Kelamin"};
        ...
        try {
            String sql = "SELECT \n" +
                    ...
                    "jabatan_karyawan.nama_jabatan_karyawan,\n" +
                    "karyawan.no_telp_karyawan,\n" +
                    "karyawan.email_karyawan,\n" +
                    "karyawan.jenis_kelamin_karyawan\n" +
                    "FROM karyawan\n" +
                    "LEFT JOIN jabatan_karyawan ON jabatan_karyawan.id_jabatan_karyawan = karyawan.id_jabatan_karyawan "
                    + "WHERE karyawan.id_karyawan LIKE '%"
                    + cariitem+ "%' or karyawan.nama_karyawan LIKE '%" 
                    + cariitem+ "%' or karyawan.no_telp_karyawan LIKE '%"
                    + cariitem+ "%' ORDER BY karyawan.id_karyawan asc";
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Data Karyawan", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PopUpKaryawan dialog = new PopUpKaryawan(new javax.swing.JFrame(), true);
