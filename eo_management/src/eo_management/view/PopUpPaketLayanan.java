 ...
 * @author it
 */
public class PopUpPaketLayanan extends javax.swing.JDialog {
     ...
     */
    public PopUpPaketLayanan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dataTable();
    }
    ...
    private void tabelPaketLayananMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelPaketLayananMouseClicked
        ...
        int pilihan = JOptionPane.showOptionDialog(null, "Pilih " + tabelPaketLayanan.getValueAt(bar,1).toString() + " Untuk Form Pemesanan Layanan ?","Message", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE,
        null,ObjButton,ObjButton[1]);
        if(pilihan == 1){
            this.dispose();
            throwDataPesanan.setId_PaketLayanan(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpPaketLayanan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PopUpPaketLayanan dialog = new PopUpPaketLayanan(new javax.swing.JFrame(), true);
